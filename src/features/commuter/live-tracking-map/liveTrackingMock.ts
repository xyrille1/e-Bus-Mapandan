export type BusOperationalStatus = 'En Route' | 'At Terminal' | 'Offline' | 'Delayed';
...
const stationSeed: StationSnapshot[] = [
  { id: 'ST-01', name: 'Manaoag Public Terminal', latitude: 16.0434, longitude: 120.4866 },
  { id: 'ST-02', name: 'Binalonan Stop', latitude: 16.0588, longitude: 120.5159 },
  { id: 'ST-03', name: 'Urdaneta Junction', latitude: 16.0673, longitude: 120.5369 },
  { id: 'ST-04', name: 'Sta. Barbara Stop', latitude: 16.0793, longitude: 120.5658 },
  { id: 'ST-05', name: 'Calasiao Bus Stop', latitude: 15.912, longitude: 120.3623 },
  { id: 'ST-06', name: 'Dagupan City Bus Terminal', latitude: 16.0912, longitude: 120.5948 }
];
...
export function filterStations(stations: StationSnapshot[], query: string): StationSnapshot[] {
...
export function getDeadReckonedBus(lastLiveBus: BusSnapshot, offlineMinutes: number): BusSnapshot {
